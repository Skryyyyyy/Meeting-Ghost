  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 flex flex-col selection:bg-zinc-900 selection:text-white">
      ...
      <section className="relative pt-16 pb-20 px-4 max-w-5xl mx-auto text-center">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-zinc-100 border border-zinc-200 text-xs font-semibold text-zinc-800 mb-6 shadow-xs">
          <Lock className="w-3.5 h-3.5 text-zinc-900" />
          Zero Cloud Uploads • AES-GCM-256 Encrypted Vault
        </div>
        ...
        {/* Live Feature Showcase Card */}
        <div className="mt-14 p-6 sm:p-8 bg-zinc-50 border border-zinc-200 rounded-3xl shadow-sm max-w-4xl mx-auto text-left">
      ...
      <section className="py-16 px-4 max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xs sm:text-sm text-zinc-500 mt-2">
            Everything you need to turn verbal discussions into action items
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 bg-white border border-zinc-200 rounded-3xl shadow-sm space-y-3">
      ...
      <footer className="mt-auto border-t border-zinc-200 py-10 px-4 bg-white text-center text-xs text-zinc-500">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-4">
            <button onClick={onLaunchApp} className="hover:text-zinc-900 cursor-pointer">
              Launch App
            </button>
